...
public:
	...
	GunnerTower()
	{
		...
		// 设置空闲状态动画
		setAnimation(anim_idle_up, tex_gunner, 3, 8, idx_list_idle_up);
		setAnimation(anim_idle_down, tex_gunner, 3, 8, idx_list_idle_down);
		setAnimation(anim_idle_left, tex_gunner, 3, 8, idx_list_idle_left);
		setAnimation(anim_idle_right, tex_gunner, 3, 8, idx_list_idle_right);

		// 设置攻击状态动画
		setAnimation(anim_fire_up, tex_gunner, 3, 8, idx_list_fire_up);
		setAnimation(anim_fire_down, tex_gunner, 3, 8, idx_list_fire_down);
		setAnimation(anim_fire_left, tex_gunner, 3, 8, idx_list_fire_left);
		setAnimation(anim_fire_right, tex_gunner, 3, 8, idx_list_fire_right);
